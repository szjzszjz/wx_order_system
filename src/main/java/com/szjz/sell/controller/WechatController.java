...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) {
        ...
        String url = projectUrlCofigProperty.getWechatMpAuthorize() + "/sell/wechat/userInfo";
    ...
    public String qrAuthorize(@RequestParam("returnUrl") String returnUrl) {
        ...
        String url = projectUrlCofigProperty.getWechatOpenAuthorize() + "/sell/wechat/qrUserInfo";
        url = URLEncoderUtil.encoderUTF8(url);
        returnUrl = URLEncoderUtil.encoderUTF8(returnUrl);
